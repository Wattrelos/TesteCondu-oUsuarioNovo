...
public class TestesSimulacaodecompraClienteCadastradoPatriciaTavaresComEnderecoComCartao {
	
	/*
	 * Este teste é para o cliente já com endereço e cartão cadastrados.
	 * 
	 */
	@Test
