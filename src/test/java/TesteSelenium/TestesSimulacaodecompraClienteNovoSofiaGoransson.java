...
public class TestesSimulacaodecompraClienteNovoSofiaGoransson {
...
//		Se o CEP exister, haverá algum dado como resposta
		Assert.assertEquals("Santana de Parnaíba", driver.findElement(By.id("cidade")).getAttribute("value"));
		// continua...
